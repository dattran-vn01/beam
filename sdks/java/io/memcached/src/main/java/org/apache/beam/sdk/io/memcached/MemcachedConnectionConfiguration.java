...
/**
 * {@code MemcachedConnectionConfiguration} describes and wraps a connectionConfiguration to Redis
 * server or cluster.
 */
@AutoValue
public abstract class MemcachedConnectionConfiguration implements Serializable {
